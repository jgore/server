...
class Nav extends Component {
  ...
  renderContent() {
    switch (this.state.auth) {
      ...
      default:
        return (<div style={{ color: "white" }} className="flexible flexible-horizontal-center flexible-vertical-space-between">
  ...
  render() {
    return (
      <div className="flexible flexible-vertical-center sticky-nav-top">
        <Navbar bg="dark" variant="dark" className="custom-container" expand="md" expanded={this.state.navExpanded} onToggle={this.setNavExpanded.bind(this)}>
          <Navbar.Brand>
            GJava
          </Navbar.Brand>
