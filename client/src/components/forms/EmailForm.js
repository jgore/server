      ...
      <div style={{ marginTop: 50, marginBottom: 50 }}>
        <form onSubmit={this.handleSubmit}>
          <div className="col-auto my-1">
            ...
            <label className="mr-sm-2" htmlFor="subject">
              Temat
            </label>
            <select
            ...
            >
              ...
              <option value="java00">
                Kurs Programowania Java 00 - Korepetycje [ 0 lat doświadczenia ]
              </option>
              <option value="java0">
                Kurs Programowania Java 0 - Company [ 0 lat doświadczenia ]
              </option>
              <option value="java1">
                Kurs Programowania Java 1 - Shop [ 0,1,2 lat doświadczenia ]
              </option>
              <option value="java1++">
                Kurs Programowania Java 1++ - Flights [ projekt + rozmowa
                kwalifikacyjna + zadanie ] - [ 1,2 lat doświadczenia ]
              </option>
              <option value="java2">
                Kurs programowania Java 2 - Bookify 2 [ 2++ lat doświadczenia ]
              </option>
          ...
          <div style={{ margin: 20 }} className="form-group">
            ...
            />
            <small id="emailHelp" className="form-text text-muted">
              We will call you back if you will leave phone number.
            </small>
          </div>
          <div style={{ margin: 20 }} className="form-group">
            <ReCaptcha
